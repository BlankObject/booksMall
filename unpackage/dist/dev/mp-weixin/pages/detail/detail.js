...
/***/ 83:
/*!********************************************************************!*\
  !*** E:/codeTest/books/main.js?{"page":"pages%2Fdetail%2Fdetail"} ***!
  \********************************************************************/
...
/***/ 84:
/*!*************************************************!*\
  !*** E:/codeTest/books/pages/detail/detail.vue ***!
  \*************************************************/
/*! no static exports found */
...
/* harmony import */ var _detail_vue_vue_type_template_id_3e159eb4_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./detail.vue?vue&type=template&id=3e159eb4&scoped=true& */ 85);
...
/* harmony import */ var _detail_vue_vue_type_style_index_0_id_3e159eb4_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./detail.vue?vue&type=style&index=0&id=3e159eb4&lang=scss&scoped=true& */ 89);
...
/***/ 85:
/*!********************************************************************************************!*\
  !*** E:/codeTest/books/pages/detail/detail.vue?vue&type=template&id=3e159eb4&scoped=true& ***!
  \********************************************************************************************/
...
try {
  components = {
    uTabs: function() {
      return Promise.all(/*! import() | node-modules/uview-ui/components/u-tabs/u-tabs */[__webpack_require__.e("common/vendor"), __webpack_require__.e("node-modules/uview-ui/components/u-tabs/u-tabs")]).then(__webpack_require__.bind(null, /*! uview-ui/components/u-tabs/u-tabs.vue */ 174))
    },
    goodsDetail: function() {
      return __webpack_require__.e(/*! import() | components/goods-detail/goods-detail */ "components/goods-detail/goods-detail").then(__webpack_require__.bind(null, /*! @/components/goods-detail/goods-detail.vue */ 265))
    },
    goodsComments: function() {
      return __webpack_require__.e(/*! import() | components/goods-comments/goods-comments */ "components/goods-comments/goods-comments").then(__webpack_require__.bind(null, /*! @/components/goods-comments/goods-comments.vue */ 270))
    },
    goodsDemo: function() {
      return __webpack_require__.e(/*! import() | components/goods-demo/goods-demo */ "components/goods-demo/goods-demo").then(__webpack_require__.bind(null, /*! @/components/goods-demo/goods-demo.vue */ 277))
    },
    uIcon: function() {
    ...
    uSkeleton: function() {
      return __webpack_require__.e(/*! import() | node-modules/uview-ui/components/u-skeleton/u-skeleton */ "node-modules/uview-ui/components/u-skeleton/u-skeleton").then(__webpack_require__.bind(null, /*! uview-ui/components/u-skeleton/u-skeleton.vue */ 202))
    }
  }
} catch (e) {
  if (
...
/***/ 87:
/*!**************************************************************************!*\
  !*** E:/codeTest/books/pages/detail/detail.vue?vue&type=script&lang=js& ***!
  \**************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var _default =
{
  ...
  onLoad: function onLoad(option) {var _this = this;
    ...
    this.$u.api.getGoodsDetail(option.goodsId * 1).then(function (res) {
      _this.loading = false;
      _this.detailData = res;
      console.log(_this.detailData);
      _this.list[1].count = res.goods.comments.length;
      //获取收藏的状态
      _this.isCollection = _this.detailData.goods.is_collect;
    });
    //获取购物车列表
    this.getCartList();
  },
  methods: {
    ...
    //收藏
    collection: function collection(index) {var _this2 = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var result;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:_context.next = 2;return (

                  _this2.$u.api.collectGoods(_this2.goodsId));case 2:result = _context.sent;
                if (result.statusCode === 201) {
                  _this2.$refs.uToast.show({
                    title: '收藏成功',
                    type: 'success' });

                  _this2.isCollection = 1;
                } else {
                  _this2.$refs.uToast.show({
                    title: '取消收藏',
                    type: 'success' });

                  _this2.isCollection = 0;
                }case 4:case "end":return _context.stop();}}}, _callee);}))();
    },
    //获取购物车列表商品个数
    getCartList: function getCartList() {var _this3 = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee2() {var result;return _regenerator.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:_context2.next = 2;return (
                  _this3.$u.api.getCartList());case 2:result = _context2.sent;
                _this3.cartNum = result.data.reduce(function (pre, curr) {
                  return pre + curr.num * 1;
                }, 0);
                console.log(_this3.cartNum);
                console.log(result);case 6:case "end":return _context2.stop();}}}, _callee2);}))();
    } },
...
/***/ 89:
/*!***********************************************************************************************************!*\
  !*** E:/codeTest/books/pages/detail/detail.vue?vue&type=style&index=0&id=3e159eb4&lang=scss&scoped=true& ***!
  \***********************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
